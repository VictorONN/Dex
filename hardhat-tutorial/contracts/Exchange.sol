...
function addLiquidity(uint _amount) public payable returns (uint) {
    ...
    */
    ...
    if (cryptoDevTokenReserve == 0) {
        ...
        need to be supplied to prevent any large price impacts because of the added liquidity
         */
         ...
         // The amount of LP tokens that would bbe sent to the user should be proportional to the liquidity of ether 
         // added by the user
...
function removeLiquidity(uint _amount) public returns (uint, uint) {
    ...
    // Transfer `ethAmount` of Eth to user's wallet from the contract
    payable(msg.sender).transfer(ethAmount);
    // Transfer `cryptoDevTokenAmount` of Crypto Dev tokens to the user's wallet from the contract
